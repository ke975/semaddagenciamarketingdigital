      ...
      <section className="py-24 bg-gray-900 text-white min-h-screen">
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-4xl font-extrabold mb-4">Pro Web</h1>
            <p className="text-gray-400 text-lg mb-6">
             Este paquete incluye pasarela de pagos, catálogo de productos y todo lo que necesitás para vender online.
            </p>
           ...
           Desde US$ 850
            ...
            <p className="text-gray-400 mb-8">
              60% al inicio, 40% en 30 días. Consultar por opciones de financiamiento sin intereses.
            </p>
