...
import Logo from '../assets/Logo.png'
 export function Nav() {
    ...
    //     { title: "Sobre Nosotros ", path: "javascript:void(0)" },
    //     { title: "Contactanos", path: "javascript:void(0)" },
    ...
    return (
        <nav className={`bg-slate-900  pb-5 md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0" : ""}`}>
